...
@Entity
@Table(indexes = { 
		@Index(name = "order_item_meta_key", columnList = "meta_key", unique = false),
		@Index(name = "order_item_meta_key_order", columnList = "order_item_id,meta_key", unique = false),
		@Index(name = "order_item_meta_site", columnList = "order_item_id,site_id", unique = false)
	}
)
public class OrderItemMeta extends AbstractEntity{
